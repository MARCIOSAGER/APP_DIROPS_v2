...
const CANAIS_DISPONIVEIS = [
  // WhatsApp oculto — ZAPI nao mantido no on-premise por enquanto.
    ...
    <div className="p-6 bg-slate-50 dark:bg-slate-950 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex gap-2 border-b border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 rounded-t-lg p-4 sticky top-0 z-20">
          ...
          {/* Aba Atendimento (WhatsApp/ZAPI) oculta — nao mantido no on-premise por enquanto. */}
          ...
          {/* Aba Grupos WhatsApp oculta — ZAPI nao mantido no on-premise por enquanto. */}
        </div>
